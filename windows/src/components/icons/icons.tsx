  ...
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" stroke={color}
      ...
      <path d="M2 5a2 2 0 0 1 2-2h3l2 2h5a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5z"
        className="ic-stroke" style={{ strokeDasharray: 50, strokeDashoffset: 50 }} />
    </svg>
  )
}
...
export function IconPlay({ size = 18, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" stroke={color}
      ...
      <polygon points="6,4 15,9 6,14" fill={color} stroke="none" className="ic-spark" style={{ opacity: 0 }} />
    </svg>
  )
}
...
export function IconDownload({ size = 18, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" stroke={color}
      strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 3v8M5 8l4 4 4-4" className="ic-stroke" style={{ strokeDasharray: 20, strokeDashoffset: 20 }} />
      <path d="M3 14h12" className="ic-stroke" style={{ strokeDasharray: 15, strokeDashoffset: 15 }} />
    </svg>
  )
}
...
export function IconTrash({ size = 18, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" stroke={color}
      strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 5h12M8 8v5M10 8v5M6 5l1-2h4l1 2" className="ic-stroke" style={{ strokeDasharray: 50, strokeDashoffset: 50 }} />
      <rect x="4" y="5" width="10" height="10" rx="2" className="ic-stroke" style={{ strokeDasharray: 40, strokeDashoffset: 40 }} />
    </svg>
  )
}
...
export function IconArchive({ size = 18, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" stroke={color}
      strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="3" width="14" height="4" rx="1.5" className="ic-stroke" style={{ strokeDasharray: 40, strokeDashoffset: 40 }} />
      <path d="M3 7v7a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7" className="ic-stroke" style={{ strokeDasharray: 40, strokeDashoffset: 40 }} />
      <path d="M7 11h4" />
    </svg>
  )
}
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" stroke={color}
      ...
      <path d="M13.5 12.5H12A4 4 0 0 1 8 8.5a3.5 3.5 0 0 1 6.94-.7H15a2.5 2.5 0 0 1 0 5z"
        className="ic-stroke" style={{ strokeDasharray: 50, strokeDashoffset: 50 }} />
      <path d="M4 12.5A3 3 0 0 1 3.5 6.6 4.5 4.5 0 0 1 12 8" className="ic-stroke" style={{ strokeDasharray: 40, strokeDashoffset: 40 }} />
    </svg>
  )
}
...
export function IconCheck({ size = 18, color = 'var(--good)' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" stroke={color}
      ...
      <path d="M4 9l4 4 6-7" className="ic-stroke" style={{ strokeDasharray: 25, strokeDashoffset: 25 }} />
    </svg>
  )
}
...
export function IconDaVinci({ size = 18, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" stroke={color}
      strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="9" cy="9" r="7" className="ic-stroke" style={{ strokeDasharray: 50, strokeDashoffset: 50 }} />
      <path d="M6 6h4a2 2 0 0 1 0 4H8v2" />
      <circle cx="9" cy="13.5" r="0.75" fill={color} stroke="none" className="ic-spark" style={{ opacity: 0 }} />
    </svg>
  )
}
